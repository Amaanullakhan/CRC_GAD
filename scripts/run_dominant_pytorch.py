#!/usr/bin/env python3
"""Run PyTorch DOMINANT + CRC-GAD under the pinned injection/partition protocol."""
...
def main():
    ...
    p.add_argument("--datasets", default="cora,citeseer,pubmed")
    p.add_argument("--seeds", default="0,1,2,3,4")
    p.add_argument("--epochs", type=int, default=100)
    p.add_argument("--out", default=str(ROOT / "results" / "dominant_pytorch.csv"))
    args = p.parse_args()
